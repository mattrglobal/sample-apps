...
// Displays the verification result for a single received mDoc credential:
...
// - All received claims organized by namespace
...
// Converts SDK claim values (MobileCredentialElementValue) into human-readable strings for display.
